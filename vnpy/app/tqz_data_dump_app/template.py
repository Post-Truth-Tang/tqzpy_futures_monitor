...
class StrategyTemplate(ABC):
    ...
    def __init__(
        self,
        strategy_engine: "DataDumpEngine",
        strategy_name: str,
        vt_symbols: List[str],
        setting: dict,
    ):
        """"""
        self.strategy_engine: "DataDumpEngine" = strategy_engine
        self.strategy_name: str = strategy_name

        # self.vt_symbols = strategy_engine.all_vt_symbols  # 订阅全市场品种: 极其耗费线程资源, 不建议使用;
        self.vt_symbols = []
    ...
    def on_daily_bar(self, bar: BarData):
        """
        Callback of daily bar data update.
        """
        pass
    ...
    @staticmethod
    def tqz_get_real_position(market_vt_symbol, direction: Direction):
        """
        get real position data(buy, sell, net)
        """

        return TQZPositionData.tqz_get_real_position(
    ...
    def get_pricetick(self, vt_symbol: str):
        ...
        return self.strategy_engine.get_pricetick(vt_symbol)

    def get_bigpointvalue(self, vt_symbol: str):
        """
        Return bigpointvalue data of trading contract.
        """

        return self.strategy_engine.get_bigpointvalue(vt_symbol)
