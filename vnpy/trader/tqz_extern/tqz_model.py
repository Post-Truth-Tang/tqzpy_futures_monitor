...
class TQZMonitorTimeModel:
    ...
    MAIN_CONTRACT_LOAD_START_TIME = time(15, 5)
    MAIN_CONTRACT_LOAD_END_TIME = time(15, 10)

    RECORD_YESTERDAY_DATA_START_TIME = time(15, 20)
    RECORD_YESTERDAY_DATA_END_TIME = time(15, 24)

    SEDIMENTARY_FUND_LOAD_START_TIME = time(15, 25)
    SEDIMENTARY_FUND_LOAD_END_TIME = time(15, 28)

    AUTO_REPORT_START_TIME = time(15, 30)
...
class TQZAccountModel:
    ...
    def __init__(self, account_id, balance, risk_percent, yesterday_accounts_data=None):
        ...
        self.account_name, self.account_number = self.__get_accountId_name_number(account_id=self.account_id)
    ...
    # --- private part ---
    @staticmethod
    def __get_accountId_name_number(account_id: str):
        ...
        if account_id in accounts_name_setting_content.keys():
            ...
            account_number = accounts_name_setting_content[account_id][TQZAccountNameType.NUMBER.value]
        else:
            account_name = "XXXX"
            account_number = -1
